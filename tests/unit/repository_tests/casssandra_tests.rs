use Notify::{models::notification::Notification, repository::{cassandra_repository::{BlockedNotificationsCassandra, NotificationsToSendCassandra}, repository::Repository}};
...
async fn test_get_for_not_existing_in_blocked_notifications_table() {
	...
	let notification = Notification{sourceid, userid, typ};
